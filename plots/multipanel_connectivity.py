...
network = os.path.join(os.path.dirname(__file__), "..", "networks", "preliminary_test.hdf5")
...
def plot():
    ...
    fig1 = plot_morphology(m_pre2, offset=pos_pre, show=False, segment_radius=4)
    plot_voxel_cloud(m_pre2.cloud, selected_voxels=[], fig=fig1, offset=pos_pre, set_range=False)
