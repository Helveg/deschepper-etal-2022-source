...
def plot():
    ...
    figs = {}
    with h5py.File(results_path("results_NEST_stim_on_MFs_PoissFinal2_finetuning0-02.hdf5"), "a") as f:
        ...
        figs["poiss"] = fig = hdf5_plot_psth(scaffoldInstance, f["/recorders/soma_spikes"], show=False, cutoff=300, duration=5)
